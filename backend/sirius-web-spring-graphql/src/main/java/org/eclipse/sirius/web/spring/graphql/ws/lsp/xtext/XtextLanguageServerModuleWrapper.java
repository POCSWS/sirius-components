...
import org.eclipse.sirius.web.spring.graphql.ws.lsp.SiriusWebLanguageServerImpl;
...
public class XtextLanguageServerModuleWrapper {
    ...
    private final ServerModule serverModule = new ServerModule() {
        ...
        protected void configure() {
            ...
            this.bind(IResourceValidator.class).to(ResourceValidatorImplWithPostValidation.class);
