...
import org.eclipse.sirius.web.collaborative.lsp.api.dto.RenameLspTextInput;
...
public class LspTextEventProcessor implements ILspTextEventProcessor {
    ...
    public LspTextEventProcessor(IEditingContext editingContext, ILspTextContext lspTextContext, List<ILspTextEventHandler> lspTextEventHandlers, ISubscriptionManager subscriptionManager,
        ...
        // We automatically refresh the representation before using it since things may
        // have changed since the moment it
        // has been saved in the database. This is quite similar to the auto-refresh on
        // loading in Sirius.
    ...
    public Optional<EventHandlerResponse> handle(IRepresentationInput representationInput) {
        ...
        if (effectiveInput instanceof ILspTextInput) {
            ...
            if (optionalLspTextEventHandler.isPresent()) {
                ...
                EventHandlerResponse eventHandlerResponse = lspTextEventHandler.handle(this.editingContext, this.lspTextContext, lspTextInput);
    ...
    public void refresh(IInput input, ChangeDescription changeDescription) {
        if (this.shouldRefresh(changeDescription)) {
            ...
            this.lspTextEventFlux.lspTextRefreshed(input, refreshedLspText);
        }
    }
