...
/**
 * This is the item provider adapter for a {@link org.omg.sysml.lang.sysml.LiteralBoolean} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class LiteralBooleanItemProvider extends LiteralExpressionItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 SysMLPackage.Literals.LITERAL_BOOLEAN__VALUE,
				 true,
				 false,
				 false,
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/LiteralBoolean"));
	}
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ?
			getString("_UI_LiteralBoolean_type") :
			getString("_UI_LiteralBoolean_type") + " " + label;
	}
