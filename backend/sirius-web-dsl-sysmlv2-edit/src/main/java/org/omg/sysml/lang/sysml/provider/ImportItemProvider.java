...
/**
 * This is the item provider adapter for a {@link org.omg.sysml.lang.sysml.Import} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ImportItemProvider extends RelationshipItemProvider {
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addImportedMemberNamePropertyDescriptor(object);
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 SysMLPackage.Literals.IMPORT__IMPORTED_NAMESPACE,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addVisibilityPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Import_visibility_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Import_visibility_feature", "_UI_Import_type"),
				 SysMLPackage.Literals.IMPORT__VISIBILITY,
				 true,
				 false,
				 false,
	...
	/**
	 * This adds a property descriptor for the Imported Member Name feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addImportedMemberNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Import_importedMemberName_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Import_importedMemberName_feature", "_UI_Import_type"),
				 SysMLPackage.Literals.IMPORT__IMPORTED_MEMBER_NAME,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	/**
	 * This adds a property descriptor for the Is Recursive feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addIsRecursivePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Import_isRecursive_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Import_isRecursive_feature", "_UI_Import_type"),
				 SysMLPackage.Literals.IMPORT__IS_RECURSIVE,
				 true,
				 false,
				 false,
	...
	/**
	 * This adds a property descriptor for the Is Import All feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addIsImportAllPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Import_isImportAll_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Import_isImportAll_feature", "_UI_Import_type"),
				 SysMLPackage.Literals.IMPORT__IS_IMPORT_ALL,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.BOOLEAN_VALUE_IMAGE,
