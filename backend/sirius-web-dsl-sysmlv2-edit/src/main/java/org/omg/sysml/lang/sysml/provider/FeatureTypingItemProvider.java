...
/**
 * This is the item provider adapter for a {@link org.omg.sysml.lang.sysml.FeatureTyping} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class FeatureTypingItemProvider extends SpecializationItemProvider {
	/**
	 ...
	 * @generated
	 */
	public FeatureTypingItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_FeatureTyping_typedFeature_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_FeatureTyping_typedFeature_feature", "_UI_FeatureTyping_type"),
				 SysMLPackage.Literals.FEATURE_TYPING__TYPED_FEATURE,
				 true,
				 false,
				 true,
				 null,
	...
	/**
	 * This returns FeatureTyping.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/FeatureTyping"));
	}
	...
	public String getText(Object object) {
		String label = ((FeatureTyping)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_FeatureTyping_type") :
			getString("_UI_FeatureTyping_type") + " " + label;
	}
