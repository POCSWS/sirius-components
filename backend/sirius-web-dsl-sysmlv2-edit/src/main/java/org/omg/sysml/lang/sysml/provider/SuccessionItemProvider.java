...
/**
 * This is the item provider adapter for a {@link org.omg.sysml.lang.sysml.Succession} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SuccessionItemProvider extends ConnectorItemProvider {
	/**
	 ...
	 * @generated
	 */
	public SuccessionItemProvider(AdapterFactory adapterFactory) {
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/Succession"));
	}
	...
	public String getText(Object object) {
		String label = ((Succession)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_Succession_type") :
			getString("_UI_Succession_type") + " " + label;
	}
