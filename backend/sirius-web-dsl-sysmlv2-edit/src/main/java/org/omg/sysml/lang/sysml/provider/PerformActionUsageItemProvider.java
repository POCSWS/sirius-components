...
/**
 * This is the item provider adapter for a {@link org.omg.sysml.lang.sysml.PerformActionUsage} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PerformActionUsageItemProvider extends ActionUsageItemProvider {
	/**
	 ...
	 * @generated
	 */
	public PerformActionUsageItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 SysMLPackage.Literals.EVENT_OCCURRENCE_USAGE__EVENT_OCCURRENCE,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 SysMLPackage.Literals.PERFORM_ACTION_USAGE__PERFORMED_ACTION,
				 true,
				 false,
				 true,
				 null,
	...
	/**
	 * This returns PerformActionUsage.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/PerformActionUsage"));
	}
	...
	public String getText(Object object) {
		String label = ((PerformActionUsage)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_PerformActionUsage_type") :
			getString("_UI_PerformActionUsage_type") + " " + label;
	}
