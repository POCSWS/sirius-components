...
/**
 * This is the item provider adapter for a {@link org.omg.sysml.lang.sysml.Specialization} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Specialization_owningType_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Specialization_owningType_feature", "_UI_Specialization_type"),
				 SysMLPackage.Literals.SPECIALIZATION__OWNING_TYPE,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addGeneralPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Specialization_general_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Specialization_general_feature", "_UI_Specialization_type"),
				 SysMLPackage.Literals.SPECIALIZATION__GENERAL,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addSpecificPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Specialization_specific_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Specialization_specific_feature", "_UI_Specialization_type"),
				 SysMLPackage.Literals.SPECIALIZATION__SPECIFIC,
				 true,
				 false,
				 true,
				 null,
