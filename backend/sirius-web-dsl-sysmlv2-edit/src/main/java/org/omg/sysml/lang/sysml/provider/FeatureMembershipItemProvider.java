 ...
 * @generated
 */
public class FeatureMembershipItemProvider extends MembershipItemProvider {
	/**
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addMemberFeaturePropertyDescriptor(object);
	...
	/**
	 * This adds a property descriptor for the Member Feature feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addMemberFeaturePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_FeatureMembership_memberFeature_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_FeatureMembership_memberFeature_feature", "_UI_FeatureMembership_type"),
				 SysMLPackage.Literals.FEATURE_MEMBERSHIP__MEMBER_FEATURE,
				 true,
				 false,
				 true,
				 null,
