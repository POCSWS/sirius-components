...
/**
 * This is the item provider adapter for a {@link org.omg.sysml.lang.sysml.CalculationUsage} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CalculationUsageItemProvider extends ActionUsageItemProvider {
	/**
	 ...
	 * @generated
	 */
	public CalculationUsageItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This adds a property descriptor for the Calculation Definition feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addCalculationDefinitionPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_CalculationUsage_calculationDefinition_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_CalculationUsage_calculationDefinition_feature", "_UI_CalculationUsage_type"),
				 SysMLPackage.Literals.CALCULATION_USAGE__CALCULATION_DEFINITION,
				 true,
				 false,
				 true,
				 null,
	...
	/**
	 * This returns CalculationUsage.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/CalculationUsage"));
	}
	...
	public String getText(Object object) {
		String label = ((CalculationUsage)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_CalculationUsage_type") :
			getString("_UI_CalculationUsage_type") + " " + label;
	}
