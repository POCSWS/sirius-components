...
/**
 * This is the item provider adapter for a {@link org.omg.sysml.lang.sysml.CalculationDefinition} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CalculationDefinitionItemProvider extends ActionDefinitionItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 SysMLPackage.Literals.FUNCTION__EXPRESSION,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 SysMLPackage.Literals.FUNCTION__RESULT,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 SysMLPackage.Literals.FUNCTION__IS_MODEL_LEVEL_EVALUABLE,
				 true,
				 false,
				 false,
	...
	protected void addCalculationPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_CalculationDefinition_calculation_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_CalculationDefinition_calculation_feature", "_UI_CalculationDefinition_type"),
				 SysMLPackage.Literals.CALCULATION_DEFINITION__CALCULATION,
				 true,
				 false,
				 true,
				 null,
	...
	/**
	 * This returns CalculationDefinition.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/CalculationDefinition"));
	}
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ?
			getString("_UI_CalculationDefinition_type") :
			getString("_UI_CalculationDefinition_type") + " " + label;
	}
