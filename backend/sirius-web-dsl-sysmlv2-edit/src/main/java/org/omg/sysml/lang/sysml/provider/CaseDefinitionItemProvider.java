...
/**
 * This is the item provider adapter for a {@link org.omg.sysml.lang.sysml.CaseDefinition} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 SysMLPackage.Literals.CASE_DEFINITION__SUBJECT_PARAMETER,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 SysMLPackage.Literals.CASE_DEFINITION__ACTOR_PARAMETER,
				 true,
				 false,
				 true,
				 null,
